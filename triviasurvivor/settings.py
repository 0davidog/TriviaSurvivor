"""
Django settings for triviasurvivor project.
...
# Cloudinary configuration (call config to read CLOUDINARY_URL)
cloudinary.config()  # reads os.environ["CLOUDINARY_URL"] automatically
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'triviasurvivor@example.com'
else:
...
ROOT_URLCONF = 'triviasurvivor.urls'
...
WSGI_APPLICATION = 'triviasurvivor.wsgi.application'
