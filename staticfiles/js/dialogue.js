...
export const dialogueSet = {
    title: {
        header: "Welcome",
        text: `This is Trivia Survivor, test your knowledge of horror movie trivia against an approaching danger. Your brain is your only defence. Answer enough questions correctly to survive the nightmare. Good luck.`
    },
    intro_1: {
        header: "Introduction",
        text: `“...this is an emergency broadcast. We have received wide-spread reports of horror movie villains escaping the screen to attack victims...”`
    },
    intro_2: {
        header: "Introduction",
        text: `“...these creatures seem to be most attracted to those who are ignorant of the world they came from. We advise all citizens to remain indoors and watch only romantic comedies...”`
    },
    intro_3: {
        header: "Introduction",
        text: `“...if caught, your only hope is to repel these creatures with knowledge and escape.”`
    },
    chapter_zombie: {
        header: `Chapter 1: The Zombie`,
        text: `Exploring the abandoned mansion seemed like a great idea for video content at the time, but the various scattered lab reports and pieces of medical equipment suggest a much darker mystery best left alone. You try to leave, but in the darkness of the corridor that is your only way out you hear the shuffling steps and anguished moans of something rotten and very, very hungry...`
    },
    chapter_psycho: {
        header: `Chapter 2: The Psycho`,
        text: `Work was miserable, now it's late and all you want to do is eat pizza, shower and bed, and not necessarily in that order. The whole way home you felt like someone was watching you and now, as your stress-fried brain causes you to drop the keys to your flat, you feel a now overwhelming bloodlust from the darkness behind you. You turn around as something cold begins to approach...`
    },
    chapter_onryō: {
